    ...
    <div className="min-h-screen bg-brand-50 flex">
      ...
      <aside className="w-64 bg-white shadow-md p-6 flex flex-col gap-4">
        ...
        <nav className="flex flex-col gap-2">
          <Link to={APP_ROUTES.DASHBOARD} className="text-brand-900 hover:text-brand-500 font-medium transition-colors">
            Дашборд
          </Link>
          <Link to={APP_ROUTES.EXPENSES} className="text-brand-900 hover:text-brand-500 font-medium transition-colors">
            Расходы
          </Link>
        </nav>
      </aside>
